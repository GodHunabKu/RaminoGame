...
/**
 * ==========================================
 * CLASSIFICA GILDE - ONE SERVER (Modern Layout)
 * ==========================================
 */
?>
...
@media (max-width: 768px) {
    ...
    .points-column { min-width: 90px; }
    .leader-column { display: none; } 
...
@media (max-width: 480px) {
    ...
    .guild-name-column { min-width: 120px; }
    .level-column { width: 60px; }
    .points-column { min-width: 80px; font-size: 15px; }
}
</style>
    ...
    <div class="ranking-page-wrapper">
            ...
            <div class="ranking-hero-content">
                <div class="ranking-title-section">
                    ...
                    <div class="ranking-title-text">
                        <h1>CLASSIFICA</h1>
                        <p>Scopri le gilde pi� potenti del server</p>
                    </div>
                </div>
                
                <div class="ranking-tabs-container">
                    <a href="<?php print $site_url; ?>ranking/players" class="ranking-tab">
                        <i class="fas fa-user"></i>
                        <span>Giocatori</span>
                    </a>
                    <a href="<?php print $site_url; ?>ranking/guilds" class="ranking-tab active">
                        <i class="fas fa-shield-alt"></i>
                        <span>Gilde</span>
                    </a>
                </div>
                ...
                <table class="ranking-table-modern">
                    <thead>
                        <tr>
                            ...
                            <th class="guild-name-column">GILDA</th>
                            <th class="leader-column">CAPO</th>
                            <th class="empire-column">REGGNO</th>
                            <th class="level-column">LIVELLO</th>
                            <th class="points-column">PUNTI</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php        
        ...
        <div class="pagination-section">
            <div class="pagination-modern">
                <?php
                    if(isset($search))
                        $paginate->paginglink($query, $records_per_page, $lang['first-page'], $lang['last-page'], $site_url, $search, 'guilds');
                    else
                        $paginate->paginglink($query, $records_per_page, $lang['first-page'], $lang['last-page'], $site_url, NULL, 'guilds');
                ?>
            </div>
        </div>
...
<script>
// ==================== RANKING GUILDS PAGE JAVASCRIPT ====================
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Console art
    console.log('%c??? RANKING GILDE', 'color: #E74C3C; font-size: 20px; font-weight: bold;');
