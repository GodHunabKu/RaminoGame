<div class="ranking-header">
    ...
    <div class="ranking-tabs">
        <a href="<?php print $site_url; ?>ranking/players" class="tab-link">
...
<div class="ranking-content">
        ...
        <form action="" method="POST">
            <div class="search-input-group">
                ...
                <input 
                    ...
                    name="search" 
                    class="search-input" 
                    placeholder="<?php print $lang['guild']; ?>" 
    ...
    <div class="ranking-table-container">
        <table class="ranking-table-full ranking-guilds">
            <thead>
                <tr>
                    <th class="rank-col">#</th>
                    <th class="guild-col"><?php print $lang['guild']; ?></th>
                    <th class="leader-col"><?php print $lang['leader']; ?></th>
                    <th class="empire-col"><?php print $lang['empire']; ?></th>
                    <th class="level-col"><?php print $lang['level']; ?></th>
                    <th class="points-col"><?php print $lang['points']; ?></th>
                </tr>
            </thead>
            <tbody>
                <?php		
