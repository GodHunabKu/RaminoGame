<div class="account-page-modern">
    <div class="account-hero">
        <div class="account-hero-content">
            ...
            <h1 class="account-title"><?php if($message==7) print 'Cambia Password'; else print 'Recupero Account'; ?></h1>
            <p class="account-subtitle">Imposta una nuova password per il tuo account</p>
        </div>
    </div>
            ...
            <form role="form" method="post" action="" class="modern-login-form">
                ...
                <div class="form-section">
                    <h3 class="section-title">
                        ...
                        <?php if($message==7) print 'Nuova Password'; else print 'Recupero Account'; ?>
                    </h3>
